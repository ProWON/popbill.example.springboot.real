...
public class CashbillController {
    ...
    public String checkMgtKeyInUse(Model m) {
        /*
         * 파트너가 현금영수증 관리 목적으로 할당하는 문서번호 사용여부를 확인합니다. - 이미 사용 중인 문서번호는 중복 사용이 불가하고,
         * 현금영수증이 삭제된 경우에만 문서번호의 재사용이 가능합니다. - 문서번호는 최대 24자리 영문 대소문자, 숫자, 특수문자('-','_')만
         * 이용 가능 - https://docs.popbill.com/cashbill/java/api#CheckMgtKeyInUse
         */
    ...
    public String register(Model m) {
        /*
         * 1건의 현금영수증을 [임시저장]합니다. - [임시저장] 상태의 현금영수증은 발행(Issue API)을 호출해야만 국세청에 전송됩니다.
         */
    ...
    public String update(Model m) {
        /*
         * 1건의 현금영수증을 [수정]합니다. - [임시저장] 상태의 현금영수증만 수정할 수 있습니다. -
    ...
    public String cancelIssue(Model m) {
        /*
         * 국세청 전송 이전 "발행완료" 상태의 현금영수증을 "발행취소"하고 국세청 전송 대상에서 제외합니다. - Delete(삭제)함수를 호출하여
    ...
    public String delete(Model m) {
        /*
         * 삭제 가능한 상태의 현금영수증을 삭제합니다. - 삭제 가능한 상태: "임시저장", "발행취소", "전송실패" - 현금영수증을 삭제하면
         * 사용된 문서번호(mgtKey)를 재사용할 수 있습니다. -
    ...
    public String revokeRegister(Model m) {
        /*
         * 1건의 취소현금영수증을 [임시저장]합니다. - [임시저장] 상태의 현금영수증은 [발행(Issue API)]을 해야만 국세청에 전송됩니다.
         */
    ...
    public String revokeRegister_part(Model m) {
        /*
         * 1건의 (부분)취소현금영수증을 [임시저장]합니다. - [임시저장] 상태의 현금영수증은 [발행(Issue API)]을 해야만 국세청에
         * 전송됩니다.
         */
    ...
    public String revokeRegistIssue(Model m) {
        /*
         * 취소 현금영수증 데이터를 팝빌에 저장과 동시에 발행하여 "발행완료" 상태로 처리합니다. - 현금영수증 국세청 전송 정책 :
         * https://docs.popbill.com/cashbill/ntsSendPolicy?lang=java -
    ...
    public String revokeRegistIssue_part(Model m) {
        /*
         * 작성된 (부분)취소 현금영수증 데이터를 팝빌에 저장과 동시에 발행하여 "발행완료" 상태로 처리합니다. - 취소 현금영수증의 금액은 원본
         * 금액을 넘을 수 없습니다. - 현금영수증 국세청 전송 정책 :
         * https://docs.popbill.com/cashbill/ntsSendPolicy?lang=java -
         * https://docs.popbill.com/cashbill/java/api#RevokeRegistIssue
         */
    ...
    public String getURL(Model m) {
        /*
         * 팝빌 현금영수증 문서함 팝업 URL을 반환합니다. - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당
         * URL을 통한 페이지 접근이 불가합니다. - https://docs.popbill.com/cashbill/java/api#GetURL
         */
    ...
    public String getPopUpURL(Model m) {
        /*
         * 팝빌 사이트와 동일한 현금영수증 1건의 상세 정보 페이지의 URL을 반환합니다. - 반환되는 URL은 보안 정책상 30초 동안 유효하며,
    ...
    public String getViewURL(Model m) {
        /*
         * 팝빌 사이트와 동일한 현금영수증 1건의 상세 정보 페이지(사이트 상단, 좌측 메뉴 및 버튼 제외)의 URL을 반환합니다. - 반환되는
    ...
    public String getPrintURL(Model m) {
        /*
         * 현금영수증 1건을 인쇄하기 위한 페이지의 팝업 URL을 반환합니다. - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한
         * 후에는 해당 URL을 통한 페이지 접근이 불가합니다. -
    ...
    public String getEPrintURL(Model m) {
        /*
         * 현금영수증 인쇄(공급받는자) URL을 반환합니다. - URL 보안정책에 따라 반환된 URL은 30초의 유효시간을 갖습니다.
         */
    ...
    public String getMassPrintURL(Model m) {
        /*
         * 다수건의 현금영수증을 인쇄하기 위한 페이지의 팝업 URL을 반환합니다. (최대 100건) - 반환되는 URL은 보안 정책상 30초 동안
    ...
    public String getMailURL(Model m) {
        /*
         * 구매자가 수신하는 현금영수증 안내 메일의 하단에 버튼 URL 주소를 반환합니다. - 함수 호출로 반환 받은 URL에는 유효시간이 없습니다.
    ...
    public String getPDFURL(Model m) {
        /*
         * 현금영수증 PDF 파일을 다운 받을 수 있는 URL을 반환합니다. - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한
         * 후에는 해당 URL을 통한 페이지 접근이 불가합니다. -
    ...
    public String sendSMS(Model m) {
        /*
         * 현금영수증과 관련된 안내 SMS(단문) 문자를 재전송하는 함수로, 팝빌 사이트 [문자·팩스] > [문자] > [전송내역] 메뉴에서
         * 전송결과를 확인 할 수 있습니다. - 알림문자 전송시 포인트가 차감됩니다. (전송실패시 환불처리) -
    ...
    public String updateEmailConfig(Model m) {
         ...
         *
         * 메일전송유형 CSH_ISSUE : 고객에게 현금영수증이 발행 되었음을 알려주는 메일 입니다. CSH_CANCEL : 고객에게 현금영수증이
         * 발행취소 되었음을 알려주는 메일 입니다.
         *
         */
